    ...
    <>
      <div className="min-h-screen bg-gradient-to-b from-orange-50 to-white">
        ...
        <section className="relative py-20 px-4 overflow-hidden">
          <div className="max-w-7xl mx-auto text-center">
            <h1 className="text-4xl md:text-6xl font-bold text-gray-900 mb-6">
              Catering Services in Saddar Rawalpindi | <span className="text-orange-600">Premium & Professional Caterers</span>
            </h1>
            <p className="text-xl text-gray-600 max-w-4xl mx-auto mb-8">
              SU Catering provides exceptional catering services in Saddar Rawalpindi, offering premium quality food and professional service for all types of events. Whether you're planning a wedding, corporate event, or private gathering, our team delivers excellence right to your doorstep in Saddar.
            </p>
        ...
        <section className="py-16 px-4 bg-white">
          <div className="max-w-7xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-center text-gray-900 mb-4">
              Complete Saddar Rawalpindi Coverage
            </h2>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              <div className="bg-orange-50 p-6 rounded-xl text-center">
                ...
                <h3 className="font-semibold text-gray-900">Main Saddar Bazaar</h3>
                <p className="text-gray-600 text-sm">Commercial area catering</p>
              </div>
              <div className="bg-orange-50 p-6 rounded-xl text-center">
                <MapPin className="h-8 w-8 text-orange-600 mx-auto mb-3" />
                <h3 className="font-semibold text-gray-900">Saddar Cantt</h3>
                <p className="text-gray-600 text-sm">Military area catering</p>
              </div>
              <div className="bg-orange-50 p-6 rounded-xl text-center">
                <MapPin className="h-8 w-8 text-orange-600 mx-auto mb-3" />
                <h3 className="font-semibold text-gray-900">Saddar Surroundings</h3>
        ...
        <section className="py-16 px-4 bg-gray-50">
          <div className="max-w-7xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-center text-gray-900 mb-4">
              Our Catering Services in Saddar Rawalpindi
            </h2>
            <div className="w-24 h-1 bg-orange-600 mx-auto mb-12"></div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              <div className="bg-white p-6 rounded-xl shadow-lg">
                ...
                <p className="text-gray-600">Complete wedding solutions for Saddar</p>
              </div>
              <div className="bg-white p-6 rounded-xl shadow-lg">
              ...
              <div className="bg-white p-6 rounded-xl shadow-lg">
                ...
                <p className="text-gray-600">Live BBQ for Saddar events</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-16 px-4 bg-white">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              Why Choose SU Catering in Saddar Rawalpindi?
            </h2>
            <div className="w-24 h-1 bg-orange-600 mx-auto mb-12"></div>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="bg-orange-50 p-6 rounded-xl">
                ...
                <p className="text-gray-600">Deep knowledge of Saddar venues</p>
              </div>
              <div className="bg-orange-50 p-6 rounded-xl">
        ...
        <section className="py-16 px-4 bg-orange-600">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-3xl font-bold text-white mb-4">
              Ready to Book Catering in Saddar Rawalpindi?
            </h2>
